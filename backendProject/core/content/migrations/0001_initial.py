# Generated by Django 5.0.6 on 2024-09-09 14:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
                ('content_type', models.CharField(choices=[('IMAGE POST', 'Image Post'), ('RICH POST', 'Rich Post')], max_length=10, null=True, verbose_name='Type de post')),
                ('source', models.CharField(choices=[('etudiant', 'ETUDIANT'), ('professeur', 'PROFESSEUR'), ('service', 'SERVICE'), ('promotion', 'PROMOTION'), ('autre', 'AUTRE')], max_length=10, null=True, verbose_name='source')),
