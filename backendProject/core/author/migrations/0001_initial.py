    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status_choice', models.CharField(choices=[('etudiant', 'ETUDIANT'), ('professeur', 'PROFESSEUR'), ('administration', 'ADMINISTRATION'), ('autre', 'AUTRE')], max_length=15, verbose_name='statut')),
