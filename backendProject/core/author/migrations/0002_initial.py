...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='peerposition',
            name='peer',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='core_author.peer'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='peerposition',
            name='student',
            field=models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, to='core_author.student'),
        ),
        migrations.AddField(
            model_name='peer',
            name='manager',
