...
export default function PeerPage() {
  ...
  const { data: studentsData, error: studentsError, isLoading: studentsLoading } = 
    useSWR(peerData ? `/peer/${peerId}/students/` : null, fetcher);
  ...
  }, [peerData, studentsData]);

  if (peerLoading || studentsLoading) return <Loading />;
  if (peerError || studentsError) return <div>Erreur de chargement des données</div>;
