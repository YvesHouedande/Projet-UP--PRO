...
//     try {
//       setLoading(true);
//       const response = await axios.post('/api/send-validation-email/');
...
//     try {
//       setLoading(true);
//       const response = await axios.post('/api/validate-email/', { code: validationCode });
//       setMessage(response.data.message);
//       // Optionally, you can refresh the user's profile to update the from_inp status
//     } catch (error) {
...
//       </Modal.Body>
//       <Modal.Footer>
//         <Button onClick={sendValidationCode} disabled={loading}>
//           Renvoyer le code
//         </Button>
